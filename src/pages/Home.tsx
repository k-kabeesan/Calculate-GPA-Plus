...
export function Home() {
  return <div className="container home-page home-v2">
    <section className="home-hero-v2">
      <div className="home-hero-copy"><span className="hero-badge"><Zap size={14} /> FAST, PRIVATE &amp; ACADEMIC READY</span><h1>Your GPA journey,<br /><em>all in one place.</em></h1><p>Calculate semester GPA and CGPA, build reusable academic profiles, and create result reports with a simple tool made for university students.</p><div className="home-hero-actions"><a className="button button-primary" href="#/calculator"><Calculator size={18} /> Calculate GPA now</a><a className="button button-hero" href="#/create"><GraduationCap size={18} /> Create Profile</a><a className="button button-hero" href="#/search"><Search size={18} /> Find my profile</a></div><div className="home-trust-row"><span><Check size={15} /> No account</span><span><Check size={15} /> Private grade choices</span><span><Check size={15} /> Free to use</span></div></div>
